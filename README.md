...
# nautilus
CLI or command line tool for communicating with a Kubernetes cluster. This project is a basic exercise experiment with the kubernetes python library and interact with a simple cluster. It provides a limited set of commands to interact with a Kubernetes cluster, making it easier for beginners to understand and use Kubernetes.
